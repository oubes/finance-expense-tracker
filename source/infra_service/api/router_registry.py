...
from source.infra_service.api.routes.chunking_routes import router as chunking_router
...
def register_routes(app):
    ...
    app.include_router(chunking_router, prefix="/api/infra/chunking", tags=["chunking"])
    return app