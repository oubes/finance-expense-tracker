...
class UserFactsUseCase:
    ...
    async def init(self) -> bool:
        logger.info("[User Facts Use Case] initializing versioned table...")
        ...
        try:
            ...
            logger.exception(f"[User Facts Use Case] init failed: {e}")
            return False
    ...
    async def add(self, data: tuple) -> bool:
        ...
        try:
            ...
            logger.exception(f"[User Facts Use Case] add failed: {e}")
            return False
    ...
    async def count(self) -> int:
        try:
            ...
            logger.exception(f"[User Facts Use Case] count failed: {e}")
            return 0
    ...
    async def count_user(self, user_id: str) -> int:
        try:
            ...
            logger.exception(f"[User Facts Use Case] count_user failed: {e}")
            return 0