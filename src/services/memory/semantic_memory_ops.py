...
class SemanticMemoryOps:
    ...
    async def init(self) -> bool:
        ...
        try:
            ...
            logger.exception("[MemoryOps] init failed")
            return False
    ...
    async def add_message(
        ...
        try:
            ...
            logger.exception("[MemoryOps] add_message failed")
            return False
    ...
    async def get_user_history(self, user_id: str):
        try:
            ...
            logger.exception("[MemoryOps] get_user_history failed")
            return []
    ...
    async def get_stm(self, user_id: str, limit: int = 10):
        try:
            ...
            logger.exception("[MemoryOps] get_stm failed")
            return []
    ...
    async def bm25_search(self, user_id: str, query: str, limit: int = 10):
        try:
            ...
            logger.exception("[MemoryOps] bm25_search failed")
            return []
    ...
    async def vector_search(self, user_id: str, embedding, limit: int = 10) -> list:
        try:
            ...
            logger.exception("[MemoryOps] vector_search failed")
            return []
    ...
    async def hybrid_search(
        ...
        try:
            ...
            logger.exception("[MemoryOps] hybrid_search failed")
            return []
    ...
    async def count(self) -> int:
        try:
            ...
            logger.exception("[MemoryOps] count failed")
            return 0